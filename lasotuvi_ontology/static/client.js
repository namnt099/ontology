...
$(document).ready(function () {
    ...
    $(".chat-body").on("click" , "button" ,function () {
        $("[cung-id]").removeClass("xungChieu");
        cungid = $(this).attr('cung-id');
        cungXungChieu = dichCung(cungid, 6);
        cungTamHop1 = dichCung(cungid, 4);
        cungTamHop2 = dichCung(cungid, 8);
        $(`div [cung-id= ${cungid}]`).addClass("xungChieu");
        $("[cung-id=" + cungXungChieu + "]").addClass("xungChieu");
        $("[cung-id=" + cungTamHop1 + "]").addClass("xungChieu");
        $("[cung-id=" + cungTamHop2 + "]").addClass("xungChieu");
        var payload = $(this).attr('payload');
        var href = $(this).attr('url');
        var data = {"sender":"tqhuy" , "message": payload }         
        $.ajax({               
            ...
            success: function (response) {               
                ...
                var url = $(`<div class="chat-bubble you text-align-left"><a href="${href}">Bấm vào đây để xem lời giải lá số</a></div>`);
                $('.chat-body').append(tag_messenger);                 
                $('.chat-body').append(url);       
    ...
    function giaiDoanLaSo(){
        console.log("Hàm giaiDoanLaSo đang được gọi");
        try{
            refresh();
            var taiLieuThamKhao = $('#tailieuthamkhao').val();
            $.ajax({
                url: 'api_giaidoan',
                method: 'GET',
                dataType: 'JSON',
                success: function(giaidoan){
                    var gd = JSON.parse(giaidoan);
                    // console.log(gd);
                    for( var i=0;i< gd.length;i++){
                        if(gd[i][3] == taiLieuThamKhao || gd[i][4] == taiLieuThamKhao || gd[i][5] == taiLieuThamKhao || taiLieuThamKhao == "Tất cả"){
                            // console.log(gd);
                            var giaidoan = $(`<div class="giaidoan" >                
                            <h4 class="nguyennhan">${gd[i][2]}</h4>
                            <em class="cauphu">${gd[i][5]}</em><p></p>
                            <p class="ketqua"><ins>Lời giải đoán</ins>: ${gd[i][3].replace('Lời giải: ','')}</p>
                            <em class="thamkhao">${gd[i][4]}</em>
                            </div>`);
                            
                            var a = $(`<div class="giaidoan" >                
                            <h4 class="nguyennhan">${gd[i][2]}</h4>
                            <p class="ketqua"><ins>Lời giải đoán</ins>: ${gd[i][3]}</p>
                            <em class="thamkhao">${gd[i][4]}</em>
                            </div>`);

                            var b = $(`<div class="giaidoan" >                
                            <h4 class="nguyennhan">${gd[i][2]}</h4>
                            <p class="ketqua">${gd[i][3]}</p>
                            <em class="thamkhao">${gd[i][5]}</em>
                            </div>`);

                            var c = $(`<div class="giaidoan" >                
                            <h4 class="nguyennhan"><b>DẠNG THỨC</b>: ${gd[i][2]}</h4>
                            <p class="ketqua"><ins>Định hướng nghề nghiệp</ins>: ${gd[i][3]}</p>
                            <em class="thamkhao">- ${gd[i][5]}</em>
                            </div>`);

                            var e = $(`<div class="giaidoan" >                
                            <h4 class="nguyennhan">${gd[i][1]}</h4>
                            <p class="ketqua">${gd[i][2]}</p>
                            <em class="thamkhao">${gd[i][3]}</em>
                            </div>`);
                            if(gd[i][1]=='PHÚ GIẢI'){
                                if (gd[i][5]==1){
                                    $('.phu-giai').append(giaidoan);
                                }
                                else if(gd[i][5]==3){
                                    $('.phu-giai').append(b);
                                }
                            ...
                            if(gd[i][0] == "GIẢI ĐOÁN CHUNG"){
                                $('.giai-doan-chung').append(e);
                            }
                            
                            else if(gd[i][1]=="CUNG MỆNH" || gd[i][0]=="CUNG MỆNH"){
                                if (gd[i][5]==1){
                                    $('.cung-menh').append(giaidoan);
                                }
                                else if(gd[i][5]==3){
                                    $('.cung-menh').append(b);
                                }
                            ...
                            else if(gd[i][1]=="CUNG THÂN"){                    
                                //$('.cung-than').append(giaidoan);   
                                if (gd[i][5]==1){
                                    $('.cung-than').append(giaidoan);
                                }
                                else if(gd[i][5]==3){
                            ...
                            else if(gd[i][1]=="CUNG QUAN LỘC" || gd[i][0]=="CUNG QUAN LỘC"){
                                //$('.cung-quan-loc').append(giaidoan);
                                if (gd[i][5]==1){
                                    $('.cung-quan-loc').append(giaidoan);
                                }
                                else if(gd[i][5]==3){
                                    $('.cung-quan-loc').append(b);
                                }
                                else if (gd[i][4] == null){
                                    $('.cung-quan-loc').append(e);
                                }
                                else{
                                    $('.cung-quan-loc').append(a);
                                }
                            }
                            else if(gd[i][1]=="CUNG TÀI BẠCH" || gd[i][0]=="CUNG TÀI BẠCH"){
                                //$('.cung-tai-bach').append(giaidoan);
                                if (gd[i][5]==1){
                                    $('.cung-tai-bach').append(giaidoan);
                                }
                                else if(gd[i][5]==3){
                                    $('.cung-tai-bach').append(b);
                                }
                                else if (gd[i][4] == null){
                                    $('.cung-tai-bach').append(e);
                                }
                                else{
                                    $('.cung-tai-bach').append(a);
                                }
                            }
                            else if(gd[i][1]=="CUNG THIÊN DI" || gd[i][0]=="CUNG THIÊN DI"){
                                //$('.cung-thien-di').append(giaidoan);
                                if (gd[i][5]==1){
                                    $('.cung-thien-di').append(giaidoan);
                                }
                                else if(gd[i][5]==3){
                                    $('.cung-thien-di').append(b);
                                }
                                else if (gd[i][4] == null){
                                    $('.cung-thien-di').append(e);
                                }
                                else{
                                    $('.cung-thien-di').append(a);
                                }
                            }
                            else if(gd[i][1]=="CUNG PHÚC ĐỨC" || gd[i][0]=="CUNG PHÚC ĐỨC"){
                                //$('.cung-phuc-duc').append(giaidoan);
                                if (gd[i][5]==1){
                                    $('.cung-phuc-duc').append(giaidoan);
                                }
                                else if(gd[i][5]==3){
                                    $('.cung-phuc-duc').append(b);
                                }
                                else if (gd[i][4] == null){
                                    $('.cung-phuc-duc').append(e);
                                }
                                else{
                                    $('.cung-phuc-duc').append(a);
                                }
                            }
                            else if(gd[i][1]=="CUNG PHU THÊ" || gd[i][0]=="CUNG PHU THÊ"){
                                //$('.cung-phu-the').append(giaidoan);
                                if (gd[i][5]==1){
                                    $('.cung-phu-the').append(giaidoan);
                                }
                                else if(gd[i][5]==3){
                                    $('.cung-phu-the').append(b);
                                }
                                else if (gd[i][4] == null){
                                    $('.cung-phu-the').append(e);
                                }
                                else{
                                    $('.cung-phu-the').append(a);
                                }
                            }
                            else if(gd[i][1]=="CUNG TỬ TỨC" || gd[i][0]=="CUNG TỬ TỨC"){
                                //$('.cung-tu-tuc').append(giaidoan);
                                if (gd[i][5]==1){
                                    $('.cung-tu-tuc').append(giaidoan);
                                }
                                else if(gd[i][5]==3){
                                    $('.cung-tu-tuc').append(b);
                                }
                                else if (gd[i][4] == null){
                                    $('.cung-tu-tuc').append(e);
                                }
                                else{
                                    $('.cung-tu-tuc').append(a);
                                }
                            }
                            else if(gd[i][1]=="CUNG ĐIỀN TRẠCH" || gd[i][0]=="CUNG ĐIỀN TRẠCH"){
                                //$('.cung-dien-trach').append(giaidoan);
                                if (gd[i][5]==1){
                                    $('.cung-dien-trach').append(giaidoan);
                                }
                                else if(gd[i][5]==3){
                                    $('.cung-dien-trach').append(b);
                                }
                                else if (gd[i][4] == null){
                                    $('.cung-dien-trach').append(e);
                                }
                                else{
                                    $('.cung-dien-trach').append(a);
                                }
                            }
                            else if(gd[i][1]=="CUNG TẬT ÁCH" || gd[i][0]=="CUNG TẬT ÁCH"){
                                //$('.cung-tat-ach').append(giaidoan);
                                if (gd[i][5]==1){
                                    $('.cung-tat-ach').append(giaidoan);
                                }
                                else if(gd[i][5]==3){
                                    $('.cung-tat-ach').append(b);
                                }
                                else if (gd[i][4] == null){
                                    $('.cung-tat-ach').append(e);
                                }
                                else{
                                    $('.cung-tat-ach').append(a);
                                }
                            }
                            else if(gd[i][1]=="CUNG PHỤ MẪU" || gd[i][0]=="CUNG PHỤ MẪU"){
                                //$('.cung-phu-mau').append(giaidoan);
                                if (gd[i][5]==1){
                                    $('.cung-phu-mau').append(giaidoan);
                                }
                                else if(gd[i][5]==3){
                                    $('.cung-phu-mau').append(b);
                                }
                                else if (gd[i][4] == null){
                                    $('.cung-phu-mau').append(e);
                                }
                                else{
                                    $('.cung-phu-mau').append(a);
                                }
                            }
                            else if(gd[i][1]=="CUNG HUYNH ĐỆ" || gd[i][0]=="CUNG HUYNH ĐỆ"){
                                //$('.cung-huynh-de').append(giaidoan);
                                if (gd[i][5]==1){
                                    $('.cung-huynh-de').append(giaidoan);
                                }
                                else if(gd[i][5]==3){
                                    $('.cung-huynh-de').append(b);
                                }
                                else if (gd[i][4] == null){
                                    $('.cung-huynh-de').append(e);
                                }
                                else{
                                    $('.cung-huynh-de').append(a);
                                }
                            }
                            else if(gd[i][1]=="CUNG NÔ BỘC" || gd[i][0]=="CUNG NÔ BỘC"){
                                //$('.cung-no-boc').append(giaidoan);
                                if (gd[i][5]==1){
                                    $('.cung-no-boc').append(giaidoan);
                                }
                                else if(gd[i][5]==3){
                                    $('.cung-no-boc').append(b);
                                }
                                else if (gd[i][4] == null){
                                    $('.cung-no-boc').append(e);
                                }
                                else{
                                    $('.cung-no-boc').append(a);
                                }
                            }
                            else if(gd[i][1]=="CHU KỲ CỦA TỬ VI TẠI 12 CUNG"){
                                var a = $(`<div class="giaidoan" >                
                                <h4 class="nguyennhan">${gd[i][2]}</h4>
                                <p class="ketqua"><ins>Lời giải đoán</ins>: ${gd[i][3]}</p>
                                <em class="thamkhao">Không xác định</em>
                                </div>`);
                                // if (gd[i][2] == 1){
                                //     $('.chu-ki-tu-vi1').append(a);
                                // }
                                // else if (gd[i][2] == 2){
                                //     $('.chu-ki-tu-vi2').append(a);
                                // }
                                // else if (gd[i][2] == 3){
                                //     $('.chu-ki-tu-vi3').append(a);
                                // }
                                // else if (gd[i][2] == 4){
                                //     $('.chu-ki-tu-vi4').append(a);
                                // }
                                // else if (gd[i][2] == 5){
                                //     $('.chu-ki-tu-vi5').append(a);
                                // }
                                // else if (gd[i][2] == 6){
                                //     $('.chu-ki-tu-vi6').append(a);
                                // }
                                // else if (gd[i][2] == 7){
                                //     $('.chu-ki-tu-vi7').append(a);
                                // }
                                // else if (gd[i][2] == 8){
                                //     $('.chu-ki-tu-vi8').append(a);
                                // }
                                // else if (gd[i][2] == 9){
                                //     $('.chu-ki-tu-vi9').append(a);
                                // }
                                // else if (gd[i][2] == 10){
                                //     $('.chu-ki-tu-vi10').append(a);
                                // }
                                // else if (gd[i][2] == 11){
                                //     $('.chu-ki-tu-vi11').append(a);
                                // }
                                // else if (gd[i][2] == 12){
                                //     $('.chu-ki-tu-vi12').append(a);
                                // }
                                $('.chu-ki-tu-vi').append(a);
                            }
                            else if(gd[i][1]=="NỮ MỆNH"){
                                // console.log(gd[i][2]);
                                $('.nu-menh').append(a);
                            }
                        }
                    }
                    $("#vunggiaidoan").removeClass("anlaso");
                },
                error: function(err){
                    alert("có lỗi xảy ra");
                }
    ...
    function giaiDoanLaSo1(){
        console.log("Hàm giaiDoanLaSo1 đang được gọi");
        try{
            refresh1();
            $.ajax({
                url: 'api_daivan',
                method: 'GET',
                dataType: 'JSON',
                success: function(giaidoan1){
                    var gd1 = JSON.parse(giaidoan1);
                    // console.log(gd1);
                    for( var i=0;i< gd1.length;i++){
                        var m = $(`<div class="giaidoan" >  
                        <h4 class="nguyennhan">${gd1[i][1]}</h4>
                        <p class="mucdo"><ins>Lời giải đoán</ins>: ${gd1[i][2]} </p>
                        <em class="thamkhao">- ${gd1[i][3]}</em>
                        </div>`);
                        // console.log("Nguyên nhân:", gd1[i][1]);
                        if (gd1[i][4] == 1){
                            $('.dai-van1').append(m);
                        } 
                        else if (gd1[i][4] == 2){
                    ...
                    for ( var i=0;i< gd1.length;i++){
                        var n = $(`<div class="mucluc">${gd1[i][0]}</div>`);
                        if ((gd1[i][4] == 1) && (gd1[i][5] < 26)){
                            $('.ten-dv1').append(n);
                        } 
                        else if ((gd1[i][4] == 2) && (gd1[i][5] < 26)){
                            $('.ten-dv2').append(n);
                        }
                        else if ((gd1[i][4] == 3) && (gd1[i][5] < 26)){
                            $('.ten-dv3').append(n);
                        }
                        else if ((gd1[i][4] == 4) && (gd1[i][5] < 26)){
                            $('.ten-dv4').append(n);
                        }
                        else if ((gd1[i][4] == 5) && (gd1[i][5] < 26)){
                            $('.ten-dv5').append(n);
                        }
                        else if ((gd1[i][4] == 6) && (gd1[i][5] < 26)){
                            $('.ten-dv6').append(n);
                        }
                        else if ((gd1[i][4] == 7) && (gd1[i][5] < 26)){
                            $('.ten-dv7').append(n);
                        }
                        else if ((gd1[i][4] == 8) && (gd1[i][5] < 26)){
                            $('.ten-dv8').append(n);
                        }
                        else if ((gd1[i][4] == 9) && (gd1[i][5] < 26)){
                            $('.ten-dv9').append(n);
                        }
                        else if ((gd1[i][4] == 10) && (gd1[i][5] < 26)){
                            $('.ten-dv10').append(n);
                        }
                        else if ((gd1[i][4] == 11) && (gd1[i][5] < 26)){
                            $('.ten-dv11').append(n);
                        }
                        else if ((gd1[i][4] == 12) && (gd1[i][5] < 26)){
                            $('.ten-dv12').append(n);
                        }
                    }
    ...
    function giaiDoanLaSo2(){
        console.log("Hàm giaiDoanLaSo2 đang được gọi");
        try{
            refresh2();
            $.ajax({
                url: 'api_vanhan',
                method: 'GET',
                dataType: 'JSON',
                success: function(giaidoan2){
                    var gd2 = JSON.parse(giaidoan2);
                    // console.log(gd2);
                    for( var i=0;i< gd2.length;i++){
                        var m = $(`<div class="giaidoan" >                
                        <h4 class="nguyennhan">${gd2[i][2]}</h4>
                        <p class="ketqua"><ins>Lời giải đoán</ins>: ${gd2[i][4]} </p>
                        <em class="thamkhao">- ${gd2[i][3]}</em>
                        </div>`);
                        // console.log(gd2[i][2]);
                        if (gd2[i][1] == 'VẬN HẠN'){
                            $('.van-han').append(m);
    ...
    function refresh(){
        ...
        $('.cung-phu-the').empty()
        $('.cung-tu-tuc').empty()
        $('.cung-dien-trach').empty()
        $('.cung-tat-ach').empty()
        $('.cung-phu-mau').empty()
        $('.cung-huynh-de').empty()
        $('.cung-no-boc').empty()
        $('.giai-doan-chung').empty()
        // $('.chu-ki-tu-vi1').empty()
        // $('.chu-ki-tu-vi2').empty()
        // $('.chu-ki-tu-vi3').empty()
        // $('.chu-ki-tu-vi4').empty()
        ...
        // $('.chu-ki-tu-vi8').empty()
        // $('.chu-ki-tu-vi9').empty()
        // $('.chu-ki-tu-vi10').empty()
        // $('.chu-ki-tu-vi11').empty()
        // $('.chu-ki-tu-vi12').empty()
        $('.chu-ki-tu-vi').empty()
        $('.nu-menh').empty()
    }
    ...
    $('input#cmd2').click(function() {
        var options = {
          //'width': 800,
        };
        var pdf = new jsPDF('p', 'pt', 'a4');
        pdf.addHTML($("form#lstv"), -1, 220, options, function() {
        ...
        $.ajax({           
            ...
            success: function (response) {               
                ...
                if(response[0]["custom"]){
                    ...
                    var btn = $(`<div class="chat-bubble you text-align-left"><a href="${href}" >Bấm vào đây để xem lời giải lá số</a></div>`);
                    $('.chat-body').append(btn);
            ...
            $.ajax({   
                ...
                success: function (response) {               
                    ...
                    if(response[0].text){
                        ...
                        if (typeof(response[0]["custom"]["text"])== "object"){
                            $.each(response[0]["custom"]["text"] , function(index , res){
                                tag_messenger = $(`<div class="chat-bubble you text-align-left">- ${res["nguyennhan"]} <br>- ${res["cauphu"]} <br>- ${res["ketqua"]} <br>- ${res["thamkhao"]}</div>`);
                                $('.chat-body').append(tag_messenger);
                            });
                        }
                        else{
...
/* <script>
        function callApiGiaiDoan() {
            return fetch('http://127.0.0.1:8000/api_giaidoan').then(response => response.json());
        }
        
        function callApiVanHan() {
            return fetch('http://127.0.0.1:8000/api_vanhan').then(response => response.json());
        }
        
        function callApiDaiVan() {
            return fetch('http://127.0.0.1:8000/api_daivan').then(response => response.json());
        }
        
        document.getElementById("laplaso").addEventListener("click", function() {
            Promise.all([callApiGiaiDoan(), callApiVanHan(), callApiDaiVan()]).then(() => {
                window.open('http://127.0.0.1:8000/api_trondoi', '_blank');
            }).catch(error => {
    ...
    // title="Cung ({{if cungAmDuong == -1}}âm{{else}}dương{{/if}}), ngũ hành {{:hanhCung}}
